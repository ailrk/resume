...
\section{EXPERIENCE}
    \datedsubsection{\textbf{Flint Healthcare} \small Fullstack software developer}{\small \textit{Vancouver, Canada}, 2021 Dec - 2024 Feb}
    ...
    \datedsubsection{\textbf{UBC CS honours program}}{\small 2020 - 2021}
        Using machine learning techniques (semi-supervised learning) to automatically assess first year programming assignments.


    \datedsubsection{\textbf{Chongqing University}  \small Developer intern }{\small \textit{Chongqing, China} , 2019 Summer}
